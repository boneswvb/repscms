...
<head>
  ...
  <title>Add Company Contact Info</title>
...
<body>
  ...
  <div class="container">
    <div class="bg-dark text-white">
      <h1>Add Company Contact Info</h1>
    </div>
  </div>
  <!-- head end -->
            ...
            <div class="card bg-secondary">
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="ContactCell">
                </div>
                <div class="form-group">
                  <label for="ContactLandlineNumber">Contact Landline Number:</label>
                  <input class="form-control" type="text" name="ContactLandlineNumber">
                </div>
                <div class="form-group">
